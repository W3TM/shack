...
flowchart TD
  A[IC-705] --- B[Macbook Pro 15]
  A --- C[Wall AC Adapter]
  A --- D[HF/VHF + UHF Diplexer]
  D --- E[W6LVP HF Loop]
  E --- G[Wall AC Adapter]
  D --- F[Slim Jim]
```
...
I have been experimenting with [remote control over HF 1](flex-radio-6400.qmd) using Windows 11 running on a Macbook Pro and Chrome Remote Desktop.
